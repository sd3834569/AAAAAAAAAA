...
//						"http://172.20.20.208:8002/mobile/home.json";
	...
	private void recordDownloadProgress() {
		...
		Log.v(TAG, "recordDownloadProgress"
				+ " downloadPos:" + mRecordTaskInfo.downloadPos
				+ " downloadContentLength:" + mRecordTaskInfo.downloadContentLength
				+ " startPos:" + mRecordTaskInfo.startPos
				+ " pogress:" + mRecordTaskInfo.calcFileProgress());
	}
	...
	Runnable mRefreshProgressRunnable = new Runnable() {
		...
		public void run() {
			...
			float progress = taskInfo.calcFileProgress(); 
